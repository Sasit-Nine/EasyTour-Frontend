                    ...
                    <div className="mx-auto w-full max-w-sm lg:w-96">
                        <div>
                            ...
                            <p className="mt-2 text-base text-gray-500">
                                คุณมีบัญชีหรือยัง ?{' '}
                                <a onClick={()=>navigate('/login')} className="cursor-pointer font-semibold text-[#F8644B] hover:text-[#F8644B]/90">
                                    เข้าสู่ระบบ
                                </a>
                            </p>
                        </div>
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="mt-2">
                                            <input
                                                ...
                                                className="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-[#F8644B] sm:text-base"
                                            />
                                            {passwordError && <p className="mb-5 text-red-500 text-sm">รหัสผ่านไม่ตรงกัน</p>}
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex gap-3">
                                            ...
                                            <label htmlFor="remember-me" className="block text-base text-gray-900">
                                                จดจำการเข้าสู่ระบบ
                                            </label>
                                        </div>
                                    </div>
